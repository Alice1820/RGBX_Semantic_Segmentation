...
class RGBXEncoderDecoder(nn.Module):
    ...
    def init_weights(self, cfg, pretrained=None):
        if pretrained:
            # logger.info('Func {} Loading pretrained model: {}'.format(self.__name__, pretrained))
            logger.info('Func {} Modals {} Loading pretrained model: {}'.format(RGBXEncoderDecoder, self.modals, pretrained))
